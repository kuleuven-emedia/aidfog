...
/// Audio Cueing Service Server Role
#if defined(CFG_APP_CUEING_SERVER)
#define BLE_CUEING_SERVER       1
#else
#define BLE_CUEING_SERVER       0
#endif
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_BCS_CLIENT || BLE_VOICEPATH || BLE_DATAPATH_SERVER || BLE_ANC_CLIENT || BLE_BMS || BLE_OTA||BLE_AI_VOICE || BLE_TOTA || BLE_TILE || BLE_CUEING_SERVER)
